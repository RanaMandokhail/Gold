...
try:
    ...
    os.system('python2 Paracetamolrana.py')
...
\033[1;94m ┈┈┈▕▕B4 M4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕RANA▏▏┈┈┈
...
\033[1;91m☞ AUTHER    : RANA MANDOKHAIL

\033[1;92m☞ WHATAPP  : 03128186223

\033[1;95m☞ FACEBOOK    : RANA MANDOKHAIL
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update MANDOKHAILTool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' RANA WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/RANA MANDOKHAIL')

	    os.system('cd $HOME && git clone https://github.com/bluebirds/Gold')
	    ...
	    psb('Congratulations RANA MANDOKHAILTool Has Been Updated Successfully')
	    ...
	    os.system('cd $HOME/Gold && Gold.py')
